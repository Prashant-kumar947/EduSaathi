...
const CourseDetails = () => {
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-30 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left  bg-gradient-to-b from-cyan-100/70">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p className="text-sm">
            Course by{" "}
            <span className="text-blue-600 underline">Edu-Saathi</span>
          </p>
                    ...
                    <ul className="list-disc md:pl-10 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1">
                          ...
                          />
                          <div className="flex items-center justify-between w-full text-gray-800 text-xs md:text-defualt">
